...
function ProjectOverlay({
  ...
  return (
    <div className='group relative overflow-hidden container rounded-3xl text-black dark:text-white'>
      ...
      <div className='flex flex-col absolute h-full w-full bg-white/85 dark:bg-black/85 -bottom-20 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-500 justify-end p-8 lg:p-12'>
        ...
        <h3 className='mt-8 text-xl font-semibold text-dark dark:text-white'>
